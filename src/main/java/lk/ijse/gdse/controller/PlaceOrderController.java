...
public class PlaceOrderController implements Initializable {
    ...
    void loadEmpIds() throws SQLException {
        ArrayList<String> empId = employeeModel.getAllEmployeesContact();
    ...
    void butAddOnAction(ActionEvent event) throws SQLException {
        ...
        String empId = employeeModel.getEmpId(empCombo.getValue());
        ...
        String recod = stockModel.getRecodLevel(txtTireId.getText());
...
//        }
    ...
    void butSearchBrandOnAction(ActionEvent event) throws SQLException {
        ...
        ArrayList<PlaceOrderDto> placeOrderDTOS = placeOrderModel.getTireByBrand(brand);
